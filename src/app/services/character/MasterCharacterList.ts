...
export class MasterCharacterList{
    public masterCharacterList: Character[] = [
        ...
        },
        {
            ...
            Rank: "Gul",
            Environment: "Homeworld",
            EarlyOutlook: "Fleet (A)",
            Education: "Fleet - Command Track",
            CareerEvents: "Conflict with a Hostile Culture, Mentored",
            CareerLength: "Veteren",
            Values: "Knowledge is power\nPersistence commands success\nOrder is necessary for progress\nResponsibility comes with command",
            Focuses: "Intimidation\nPolitics\nStrategy/Tactics\nDecisive Leadership\nAmbush Tactics\nPrecision Maneuvering",
        ...
        },
        {
            ...
            EarlyOutlook: "Agriculture or Rural (R)",
            Education: "Fleet - Operations Track",
            CareerEvents: "Called Out a Superior, Serious Injury",
            CareerLength: "Experienced",
            Values: "Loyalty is more than just a word\nJustice is the backbone of the union\nThere is no substitute for vigilance\nSensors can't tell you everything",
